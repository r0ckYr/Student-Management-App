...
public class FeesManagement implements ActionListener {
    ...
    FeesManagement()throws Exception
    {
        Border border = BorderFactory.createLineBorder(Color.GRAY, 5);

        frame = new JFrame("Fees Management Panel");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==updateButton)
        {
            ...
            new FeesPanel(userData, studentsTable);
        }
